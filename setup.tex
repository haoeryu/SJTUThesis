...
\sjtusetup{
  ...
  info = {%
    ...
    % 标题
    %
    title           = {高并发视频表决会议系统设计与开发},
    title*          = {Design and development of high concurrent video voting conference system},
    %
    % 标题页标题
    %   可使用“\\”命令手动控制换行
    %
    ...
    % 关键词
    %
    keywords        = {债权会议, 视频表决系统, 高并发, 数字化},
    keywords*       = {Creditor's rights and meeting, Video voting system, High concurrency, Digital},
    %
    % 姓名
    %
